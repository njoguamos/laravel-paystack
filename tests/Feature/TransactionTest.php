...
describe(description: 'Initialize Transaction', tests: function () {
...
describe(description: 'Verify Transaction', tests: function () {

    test(description: 'can verify a transaction', closure: function () {
        $body = [
             "status"  => true,
        ...
        $response = Transaction::verify(reference: $body['data']['id']);
